...
var _a;
(_a = document.getElementById('myForm')) === null || _a === void 0 ? void 0 : _a.addEventListener('submit', (event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (validateForm(formData)) {
        try {
            const response = yield fetch('https://6717983db910c6a6e02908c8.mockapi.io/users', {
                method: 'POST',
                headers: {
...
const button = document.getElementById('leavemsg');
const myDiv = document.getElementById('Form-container');
